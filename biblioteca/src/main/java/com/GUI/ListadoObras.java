 ...
 * @author dalzo
 */
public class ListadoObras extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tituloPanel.setText("LISTADO DE OBRAS");
        tituloPanel.setFocusable(false);
        jPanel1.add(tituloPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 830, 330));
        ...
        jPanel1.add(cartelEditorial, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 70, 20));

        editorial.setBackground(new java.awt.Color(0, 8, 16));
        editorial.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(editorial, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 80, 250, -1));
        ...
        jPanel1.add(buscarBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 500, 130, 30));
        ...
        jPanel1.add(volverBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 500, 130, 30));
    ...
    private void buscarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarBtnActionPerformed
        if(editorial.getText().isEmpty()){
            mostrarObras(obras);
        }else{
            mostrarObras(Biblioteca.listarPorEditorial(editorial.getText(), obras));
        }
    ...
    private void mostrarObras(ArrayList<Obra> obras){
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);

        for (Obra obra : obras) {
            Object[] row = new Object[3];
            row[0] = obra.getTitulo();
            row[1] = obra.getIsbn();
            row[2] = obra.getEdiciones().get(0).getEditorial();
            model.addRow(row);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoObras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
